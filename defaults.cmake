...
function(find_boost)
  if(MSVC)
    ...
    foreach(ii ${ARGN})
      ...
      find_package(Boost ${MINIMUM_BOOST_VERSION} REQUIRED ${ii})
      if(NOT Boost_FOUND)
...
function(find_freetype)
  if(MSVC)
    ...
    set(FREETYPE_LIBRARY_DEBUG "freetype271d.lib" PARENT_SCOPE)
    set(FREETYPE_LIBRARY "freetype271.lib" PARENT_SCOPE)
  else()
